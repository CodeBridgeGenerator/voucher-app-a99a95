        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-xl font-bold">Carter Bank</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Discover amazing vouchers and exclusive deals. Redeem your rewards and enjoy great savings on your favorite services.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/voucher" className="text-gray-300 hover:text-white transition-colors">
                  Browse Vouchers
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/cartHistory" className="text-gray-300 hover:text-white transition-colors">
                  Order History
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Carter Bank. All rights reserved.
            </p>
