...
const p_dateTemplate2 = (rowData, { rowIndex }) => <p >{(new Date(rowData.expDate)).toLocaleDateString()}</p>
const p_numberTemplate3 = (rowData, { rowIndex }) => <p >{rowData.value}</p>
const p_numberTemplate4 = (rowData, { rowIndex }) => <p >{rowData.points}</p>
...
<Column field="expDate" header="ExpDate" body={p_dateTemplate2} filter={selectedFilterFields.includes("expDate")} hidden={selectedHideFields?.includes("expDate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="value" header="Value" body={p_numberTemplate3} filter={selectedFilterFields.includes("value")} hidden={selectedHideFields?.includes("value")}  sortable style={{ minWidth: "8rem" }} />
<Column field="points" header="Points" body={p_numberTemplate4} filter={selectedFilterFields.includes("points")} hidden={selectedHideFields?.includes("points")}  sortable style={{ minWidth: "8rem" }} />
