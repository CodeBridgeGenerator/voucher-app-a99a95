...
import seederData from "./cartHistory.seeder.json";
...
const CartHistorySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CartHistorySeederDialogComponent);
