...
const SingleCartHistoryPage = (props) => {
...
const [voucherID, setVoucherID] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            .service("cartHistory")
            .get(urlParams.singleCartHistoryId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const voucherID = Array.isArray(res.voucherID)
            ? res.voucherID.map((elem) => ({ _id: elem._id, title: elem.title }))
            : res.voucherID
                ? [{ _id: res.voucherID._id, title: res.voucherID.title }]
                : [];
    ...
    }, [props,urlParams.singleCartHistoryId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">CartHistory</h3>
                    <SplitButton
                ...
                {/* <p>cartHistory/{urlParams.singleCartHistoryId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">VoucherID</label>
      ...
      <CommentsSection
        recordId={urlParams.singleCartHistoryId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleCartHistoryPage);
